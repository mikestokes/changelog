<nav id="header" class="fixed w-full z-10 top-0">
  ...
  <div
    ...
    style="background:linear-gradient(to right, #4dc0b5 var(--scroll),
    transparent 0);" />
  ...
  <div
    ...
    <div
      ...
      mt-2 lg:mt-0 bg-gray-100 md:bg-transparent z-20"
      id="nav-content">
      <ul class="list-reset lg:flex justify-end flex-1 items-center">
        ...
        <li class="mr-3">
          <a
            class="inline-block text-gray-600 no-underline hover:text-gray-900
